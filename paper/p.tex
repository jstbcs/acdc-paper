...
We are planning to continuously add attentional control task data to our data base. Researchers seeking to improve data accessibility and citation potential of their work are invited to submit their data and related study meta-information via our online form. \emph{\marginnote{\color{red}Julia} (add link to form)}
